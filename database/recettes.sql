...
CREATE TABLE sous_categories_recettes (
    id SERIAL PRIMARY KEY,
    categorie_id INTEGER REFERENCES categories_recettes(id),
    nom VARCHAR(200) NOT NULL
);

-- ============================
-- Table des données annuelles
-- ============================
CREATE TABLE recettes_data (
    id SERIAL PRIMARY KEY,
    sous_categorie_id INTEGER REFERENCES sous_categories_recettes(id),
    annee INTEGER NOT NULL,
    montant NUMERIC(15,2) NOT NULL,
    UNIQUE(sous_categorie_id, annee)
);
...
-- IMPÔTS 2024 (sous_categorie_id 1-7) - en millions
INSERT INTO recettes_data (sous_categorie_id, annee, montant) VALUES
...
-- DOUANES 2024 (sous_categorie_id 8-11)
INSERT INTO recettes_data (sous_categorie_id, annee, montant) VALUES
...
-- RECETTES NON FISCALES 2024 (sous_categorie_id 12-16)
INSERT INTO recettes_data (sous_categorie_id, annee, montant) VALUES
...
-- DONS 2024 (sous_categorie_id 17-20)
INSERT INTO recettes_data (sous_categorie_id, annee, montant) VALUES
